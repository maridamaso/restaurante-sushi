...
// Rota para a raiz
app.get("/", (req, res) => {
    res.send("Bem-vindo ao servidor do restaurante!");
});
    ...
    if (err instanceof multer.MulterError) {
        if (err.code === "LIMIT_FILE_SIZE") {
            return res.status(413).json({
                message:
                    "O arquivo é muito grande. O tamanho máximo permitido é 1MB.",
            });
        }
    } else if (err.message === "request entity too large") {
        return res.status(413).json({
            message:
                "A requisição é muito grande. O tamanho máximo permitido é 1MB.",
        });
    }
    next(err);
});
    ...
    appetizers: [
        {
            ...
            price: "R$ 20,00",
            imageUrl:
                "https://www.nacozinhadahelo.com.br/wp-content/uploads/2022/06/receita-de-shimeji-na-manteiga.jpg",
        },
        {
            name: "Carpaccio Atum",
            price: "R$ 20,00",
            imageUrl:
                "https://s2.glbimg.com/KtSzWsDCAT7xLLzJnF98opbs5DA=/620x455/e.glbimg.com/og/ed/f/original/2022/04/26/receita-carpaccio-maguro-atum-cebola-molho-ponzu-daiki-sushi.jpg",
        },
    ],
    maincourses: [
        {
            ...
            price: "R$ 20,00",
            imageUrl:
                "https://yuchendistribuidora.com.br/wp-content/uploads/2021/11/salmao.jpg",
        },
        {
            name: "Ebi Uramaki",
            price: "R$ 20,00",
            imageUrl:
                "https://www.padariavianney.com.br/web/image/product.template/5481/image_1024?unique=49a641d",
        },
    ],
    desserts: [
        {
            ...
            price: "R$ 20,00",
            imageUrl:
                "https://www.montaencanta.com.br/wp-content/uploads/2014/09/morango-com-nutella-3.jpg",
        },
        {
            name: "Abacaxi flambado",
            price: "R$ 20,00",
            imageUrl:
                "https://storage.googleapis.com/imagens_videos_gou_cooking_prod/production/cooking/cropped_temp_56457449354edd25f189344.38170920_.jpg",
        },
    ],
    drinks: [
        {
            ...
            price: "R$ 20,00",
            imageUrl:
                "https://res.cloudinary.com/vuca-solution/image/upload/w_744,h_559,c_fill,q_auto,f_auto/v1704509207/storage.vucasolution.com.br/sacadabar/arqs/produtos/b5e41x2bemfurr27gguu.jpg",
        },
        {
            name: "Sucos Naturais",
            price: "R$ 20,00",
            imageUrl:
                "https://www.assai.com.br/sites/default/files/blog/copos_com_sucos_de_frutas_-_suco_natural_-_assai_atacadista.jpg",
        },
    ],
};
...
app.get("/reviews", (req, res) => {
    if (req.query.username) {
        const userReviews = reviewsData.filter(
            (review) => review.username === req.query.username,
        );
...
app.post("/register", async (req, res) => {
    ...
    if (password.length < 8) {
        return res
            .status(400)
            .json({ message: "A senha deve ter pelo menos 8 dígitos" });
    }
    ...
    db.get(
        ...
        async (err, user) => {
            ...
            const role = email.includes("@sushifusion.com")
                ? "Funcionario"
                : "Cliente";
